...
## Оптимизатор (v0.5) — аналог Galapagos

Вкладка «🧬 Оптимизация» — Optuna-перебор лучших ТЭП. Отметьте, какие параметры варьировать (этажность, режимы парковок, число ДОО/СОШ, ВПП), нажмите «Запустить» — алгоритм найдёт комбинацию с **максимальной площадью квартир** при выполнении всех ограничений. Топ-N сценариев можно одной кнопкой добавить в сравнение.
