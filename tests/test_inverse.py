...
def test_density_norm_identified_as_limiting_factor():
    ...
    r = solve_max_kit(
        ...
        CalculationOptions(
            ...
            # v0.20.2: озеленение ТОП (6 м²/чел) на крупном участке срабатывает
            # раньше плотности — отключаем, чтобы изолировать сценарий «упор в
            # плотность» (норматив плотности 300 чел/га при 30 м²/чел).
            enforce_quarter_greening_norm=False,
        ),
        n,
    )
