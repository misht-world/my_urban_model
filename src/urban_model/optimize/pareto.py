...
def _select_three(
    ...
    rationales = {
        ...
        "Сбалансированный": (
            "Компромисс: площадь квартир и прибыль приводятся к шкале 0–1 "
            "(0 — худший из найденных вариантов, 1 — лучший), затем берётся "
            "вариант с максимальной полусуммой 0,5·площадь + 0,5·прибыль."
        ),
    }
