    ...
    if not recs:
        if report.n_trials_feasible == 0:
            reason = (
                ...
                "Вероятные причины:\n"
                "• Малый квартал (нормативы озеленения ТОП 6 м²/чел + 300 чел/га "
                "физически противоречивы на участках <0.5 га);\n"
                ...
                "Попробуйте: отключить нормативы озеленения ТОП / плотности в Параметрах; "
